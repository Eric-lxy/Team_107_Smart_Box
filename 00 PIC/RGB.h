...
#define send(b) LATBbits.LATB4 = 1; NOP(); NOP(); NOP(); LATBbits.LATB4 = b; NOP(); NOP(); NOP(); NOP(); LATBbits.LATB4 = 0; NOP(); NOP(); NOP(); NOP();

int numLEDs = 4; // number of LEDS in the string
